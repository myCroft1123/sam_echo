...
public class UrlExtractProcessorTests extends ESTestCase {
    ...
    public void testThatProcessorWorks() throws Exception {
        ...
        UrlExtractProcessor processor = new UrlExtractProcessor(randomAlphaOfLength(10), "description", "source_field", "target_field");
